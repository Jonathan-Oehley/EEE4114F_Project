...
print(np.shape(trainSequence.get_batch_features(0)))


# Design the model
input  = Input(shape=(img_height, img_width, 1))
conv1  = MaxPooling2D(pool_size=(3,3))(Conv2D(32, (3,3), activation='relu')(input))
conv2  = MaxPooling2D(pool_size=(3,3))(Conv2D(32, (3,3), activation='relu')(conv1))
conv3  = MaxPooling2D(pool_size=(3,3))(Conv2D(32, (3,3), activation='relu')(conv2))
flat  = Flatten()(conv3)
...
if (retrain_model):
    ...
    h = model.fit_generator(trainSequence, epochs=50, verbose=1, validation_data=validSequence, validation_steps=validSequence.__len__(), use_multiprocessing=False, workers=1)
